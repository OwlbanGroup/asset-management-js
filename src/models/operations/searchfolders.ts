...
export const ExpressionUnion$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = z.union([z.string(), z.lazy(() => Expression$inboundSchema)]);
/** @internal */
export type ExpressionUnion$Outbound = string | Expression$Outbound;
...
export const ExpressionUnion$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  ExpressionUnion
> = z.union([z.string(), z.lazy(() => Expression$outboundSchema)]);
...
export const SearchFoldersRequest$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  expression: z.union([z.string(), z.lazy(() => Expression$inboundSchema)])
    .optional(),
...
export type SearchFoldersRequest$Outbound = {
  expression?: string | Expression$Outbound | undefined;
...
export const SearchFoldersRequest$outboundSchema: z.ZodType<
  ...
  SearchFoldersRequest
> = z.object({
  expression: z.union([z.string(), z.lazy(() => Expression$outboundSchema)])
    .optional(),
